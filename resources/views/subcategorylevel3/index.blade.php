<x-master-layout>
  <head>
    ...
    <script>
        ...
        window.renderedDataTable = $('#datatablelevel3').DataTable({
                processing: true,
                serverSide: true,
                autoWidth: false,
                responsive: true,
                ...
                ajax: {
                  "type"   : "GET",
                  "url"    : '{{ route("subcategorylevel3.sub3-index-data") }}',
                  "data"   : function( d ) {
                    d.search = {
                      value: $('.dt-search').val()
                    };
                ...
                columns: [
                    {
                        name: 'check',
                        data: 'check',
                        title: '<input type="checkbox" class="form-check-input" name="select_all_table" id="select-all-table" data-type="subcategorylevel3" onclick="selectAllTable(this)">',
                        exportable: false,
                        orderable: false,
                        searchable: false,
                    },
