                            ...
                            <li style="pointer-events:none;">
                                <div class="media gap-3">
                                    ...
                                    <div class="media-body ">
                                        <h5><span class="font-weight-bold">#{{$booking->id}}</span> </h5>
                                    ...
                                    <li class="d-flex flex-wrap gap-2 align-items-start align-items-lg-center justify-content-between flex-column flex-lg-row "  style="pointer-events:none;">
                                        <div class="media align-items-center gap-3">
                                                ...
                                                <div class="media-body ">
                                                    ...
                                                    <span>{{
        optional($datetime)->date_format && optional($datetime)->time_format
        ? date(optional($datetime)->date_format, strtotime($booking->date)) . ' / ' . date(optional($datetime)->time_format, strtotime($booking->date))
        : ''
    }}</span>    
                                                    {{-- <span>{{(date("$datetime->date_format / $datetime->time_format", strtotime($booking->date)))}}</span> --}}
                                                </div>
                                        </div>
