                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            <h5 class="font-weight-bold">قائمة موفرين الخدمات</h5>
                            @if($list_status != 'pending')
                            @if($auth_user->can('provider add'))
                            <a href="{{ route('provider.create') }}" class="float-right mr-1 btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> {{ __("اضافة مزود خدمة") }}</a>
                            @endif
                            @endif
                        </div>
