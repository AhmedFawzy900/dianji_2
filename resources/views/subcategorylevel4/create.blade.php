                    ...
                    <div class="card col-md-8">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    {{ Form::label('name', __('messages.select_name', ['select' => __('Subcategory Level3')]) . ' <span class="text-danger">*</span>', ['class' => 'form-control-label'], false) }}
                                    <br />
                                    {{ Form::select(
                                        ...
                                        [
                                            ...
                                            'required',
                                            'data-placeholder' => __('messages.select_name', ['select' => __('subcategorylevel3')]),
