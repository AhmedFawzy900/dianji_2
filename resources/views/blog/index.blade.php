        ...
        <div class="card card-block card-stretch">
          <div class="card-body p-0">
            <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
              ...
              @if($auth_user->can('blog add'))
              <a href="{{ route('blog.create') }}" class="float-right mr-1 btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> {{ trans('messages.add_form_title',['form' => trans('messages.blog')  ]) }}</a>
              @endif
            </div>
      ...
      <div class="row justify-content-between">
        <div class="d-flex justify-content-end">
          ...
          <div class="datatable-filter ml-auto">
            <select name="column_status" id="column_status" class="select2 form-control" data-filter="select" style="width: 80px">
        ...
        <div>
          <!-- <div class="col-md-12">
                  <form action="{{ route('blog.bulk-action') }}" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                    @csrf
                ...
                data--submit="{{ route('blog.bulk-action') }}"
                data-datatable="reload" data-confirmation='true'
                data-title="{{ __('blog',['form'=>  __('blog') ]) }}"
                title="{{ __('blog',['form'=>  __('blog') ]) }}"
