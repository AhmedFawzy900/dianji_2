<x-master-layout>
    ...
    <div class="card">
        ...
        <div class="d-flex justify-content-end">
            ...
            <div>
                <!-- <div class="col-md-12">
                  <form action="{{ route('booking-rating.bulk-action') }}" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                    @csrf
                ...
                data--submit="{{ route('booking-rating.bulk-action') }}"
