        ...
        <div class="card card-block card-stretch">
          <div class="card-body p-0">
            <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
              <h5 class="font-weight-bold">خدمات مجمعه</h5>
              <a href="{{ route('servicepackage.create') }}" class="float-right mr-1 btn btn-sm btn-primary "><i
                  class="fa fa-plus-circle"></i> {{ __("اضافة خدمة") }}</a>
            </div>
  ...
  <div class="card">
    <div class="card-body">
      <div class="row justify-content-between">
        ...
        <div>
          <!-- <div class="col-md-12">
              <form action="{{ route('servicepackage.bulk-action') }}" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                    @csrf
                ...
                data--submit="{{ route('servicepackage.bulk-action') }}"
  ...
  <script>
    document.addEventListener('DOMContentLoaded', (event) => {
      ...
      window.renderedDataTable = $('#datatable').DataTable({
        ...
        ajax: {
          "type": "GET",
          "url": '{{ route("servicepackage.index-data") }}',
          "data": function (d) {
            d.search = {
              value: $('.dt-search').val()
            };
