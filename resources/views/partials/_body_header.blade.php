                ...
                <div class="" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                         <li class="nav-item nav-icon dropdown ml-3">
                            ...
                            <!-- <a href="#" class="search-toggle dropdown-toggle notification_list"
                                ...
                                <span
                                    class="badge badge-pill badge-danger badge-up notify_count count-mail d-none"></span>
                                ...
                                <div class="card shadow-none m-0 border-0">
                                    <div class=" p-0 ">
                                        <ul class="dropdown-menu-1 list-group list-group-flush">
                                            <?php
$language_option = sitesetupSession('get')->language_option ?? ["nl", "fr", "it", "pt", "es", "en","ar"];
                        ...
                        <li class="nav-item nav-icon dropdown">
                            <a href="#" class="nav-item nav-icon dropdown-toggle pr-0 search-toggle"
                                ...
                                <img src="{{ getSingleMedia(auth()->user(), 'profile_image') }}"
                                    class="img-fluid avatar-rounded bg-light" alt="user">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right user-dropdown"
                                ...
                                <!-- <li class="dropdown-item d-flex svg-icon">
                                    <svg class="svg-icon mr-0 text-secondary" id="home-icon" width="20" height="20"
                                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <a href="{{ route('frontend.index') }}">{{ __('الصفحة الرئيسية') }}</a>
                                </li> -->
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a
                                        href="{{ route('setting.index', ['page' => 'profile_form']) }}">{{ __('الملف الشخصي') }}</a>
                                </li>
                                @role('provider')
                                <li class="dropdown-item d-flex svg-icon">
                                    <svg class="svg-icon mr-0 text-secondary" id="h-01-p" width="20"
                                    ...
                                    <a
                                        href="{{ route('provider.show', ['provider' => auth()->id()]) }}">{{ __('my_info') }}</a>
                                </li>
                                @endrole
                                ...
                                <li class="dropdown-item d-flex svg-icon border-top">
                                    ...
                                    <a href="{{  route('setting.index') }}">{{ __('الاعدادات') }}</a>
                                </li>
                                <li class="dropdown-item  d-flex svg-icon border-top">
