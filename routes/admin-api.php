...
Route::post('/auth/login', [Api\User\UserController::class, 'login'])
->middleware('guest:sanctum');

Route::post('/auth/register', [Api\User\UserController::class, 'register'])
->middleware('guest:sanctum');



// get all governments
Route::get('/governments', [Api\User\UserController::class, 'governments'])
->middleware('guest:sanctum');

Route::get('/government_city/{government}', [Api\User\UserController::class, 'govern_city'])
->middleware('guest:sanctum');

// get all cities
Route::get('/cities', [Api\User\UserController::class, 'cities'])
->middleware('guest:sanctum');
